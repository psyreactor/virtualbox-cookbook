...
default[:virtualbox][:webportal][:versions] = { '4.0' => '7', '4.1' => '11', '4.2' => '8', '4.3' => '1' }

default[:virtualbox][:webportal][:path] = '/var/www/html'
default[:virtualbox][:webportal][:enable_apache2_default_site] = false
